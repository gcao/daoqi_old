...
var _styleAttribute=navigator.appName == 'Microsoft Internet Explorer'?'text':'innerHTML';

function icon_for(item,icon,icon_hover){
   if (icon_hover == null || icon_hover =='' ){
       icon_hover=icon;
   }
   r1="icon"+parseInt(Math.random()*9000);
   r2="icon"+parseInt(Math.random()*9000);
   var newStyle = document.createElement('style');
   eval('newStyle.' + _styleAttribute + '="."+r1+"{	background: url("+icon+") no-repeat;	height: 16px;	left: 4px;width: 16px;	position: absolute;	}."+r2+"{	background: url("+icon_hover+") no-repeat;height: 16px;	left: 4px;	position: absolute;	width: 16px;}"');
